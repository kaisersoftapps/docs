...
export default [
  ...
  {
    path: '/docs/docs',
    component: ComponentCreator('/docs/docs', 'bda'),
    routes: [
      {
        path: '/docs/docs',
        component: ComponentCreator('/docs/docs', 'ef7'),
        routes: [
          {
            path: '/docs/docs',
            ...
            routes: [
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/docs/field-craft/troubleshooting-and-support', '494'),
                exact: true,
                sidebar: "docs"
              },
              {
